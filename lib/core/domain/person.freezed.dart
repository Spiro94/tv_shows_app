...
class _$PersonTearOff {
  ...
  _Person call(
      {required int id, required String name, required ImageEntity image}) {
    return _Person(
      id: id,
      name: name,
      image: image,
...
abstract class $PersonCopyWith<$Res> {
  ...
  $Res call({int id, String name, ImageEntity image});
...
class _$_Person extends _Person {
  const _$_Person({required this.id, required this.name, required this.image})
      : super._();
...
abstract class _Person extends Person {
  const factory _Person(
      ...
      required ImageEntity image}) = _$_Person;
