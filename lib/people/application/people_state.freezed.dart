...
class _$PeopleStateTearOff {
  ...
  _Data data({required List<Person> people}) {
    return _Data(
      people: people,
    );
  }
...
abstract class _Initial extends PeopleState {
...
abstract class _Loading extends PeopleState {
...
/// @nodoc
class __$DataCopyWithImpl<$Res> extends _$PeopleStateCopyWithImpl<$Res>
...
class _$_Data extends _Data {
  const _$_Data({required this.people}) : super._();
  ...
  @override
  String toString() {
    return 'PeopleState.data(people: $people)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(people));
...
abstract class _Data extends PeopleState {
  const factory _Data({required List<Person> people}) = _$_Data;
...
abstract class _Error extends PeopleState {
